...
export const physicsPrerequisites: Record<string, string[]> = {
  ...
  "electric-circuits.sp-04": ["phys.circuit.ohm"],
  "electric-circuits.sp-05": ["phys.circuit.ohm"],
  "electric-circuits.sp-06": ["phys.circuit.divider"],
...
const physicsCircuitCapabilities: CapabilityNode[] = [
  ...
  { id: "phys.circuit.internal", label: "Find lost volts and internal resistance", point: 2, prerequisites: ["phys.circuit.ohm"],
