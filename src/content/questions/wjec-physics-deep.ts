...
const AUTHORED_MOVES: Record<string, string> = {
  ...
  "grating-wavelength": "work backwards from an observed angle to the ruling, then test the order ceiling",
  ...
  "photoelectron-energy": "bracket a work function between two photon energies",
...
export const wjecPhysicsDeepQuestions = [
  ...
  item("grating-wavelength", "waves", 2, "calculation",
    "Light of wavelength 520 nm falls on a grating. The second-order peak appears at 25.5 degrees. Use sin(25.5 degrees) = 0.431. Find the number of lines per mm of the grating, and state the highest order visible.",
  ...
  item("photoelectron-energy", "quantum", 1, "calculation",
    "Light of wavelength 400 nm ejects photoelectrons from a metal, but light of wavelength 500 nm does not. Estimate the range of possible values for the metal's work function. Use h = 6.63e-34 J s and c = 3.00e8 m s^-1.",
    ["Photon energy at 400 nm: E = hc/lambda = 4.97e-19 J.", "Photon energy at 500 nm: E = 3.98e-19 J.", "The work function lies between 3.98e-19 J and 4.97e-19 J."],
    "E = hc/λ gives 4.97×10⁻¹⁹ J at 400 nm and 3.98×10⁻¹⁹ J at 500 nm. Emission at 400 nm but not 500 nm means the work function is below 4.97×10⁻¹⁹ J and at or above 3.98×10⁻¹⁹ J."),
