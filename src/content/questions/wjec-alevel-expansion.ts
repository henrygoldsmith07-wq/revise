...
const physicsExtensionMoves: Record<string, readonly string[]> = {
  capacitance: ["define a charge–potential relation", "conserve charge across a redistribution and account for lost energy", "combine series and parallel constraints", "predict an unseen time-constant observation"],
  ...
  "orbits-universe": ["substitute orbital data into the circular-orbit relations", "apply orbital conditions in context", "interpret a redshift trend", "evaluate scatter and calibration limits"],
...
const questions: QuestionSpec[] = [
  ...
  expansionQuestion(
    ...
    [
      ...
      { prompt: "A second identical 470 μF capacitor, initially uncharged, is connected in parallel with the charged one and the supply removed. Calculate the final common p.d. and the total energy now stored, and explain any difference from the initial stored energy.", marks: 3, scheme: ["Charge is conserved: total charge shared over double the capacitance gives half the p.d., 6.0 V", "Final stored energy = 2 × ½ × 470×10⁻⁶ × 6.0² = 0.0169 J", "Energy is lower than the initial 0.0338 J; the difference is dissipated as the charges redistribute"], answer: "The total charge cannot leave the isolated pair, so it spreads over twice the capacitance and the p.d. halves to 6.0 V. The final stored energy is 2 × ½ × 470×10⁻⁶ × 36 = 0.0169 J — half the original 0.0338 J. The missing energy is transferred thermally as current flows during the redistribution.", claim: "apply charge conservation to charge sharing and account for lost energy", aos: ["AO2", "AO3"] },
  ...
  expansionQuestion(
    ...
    [
      { prompt: "A weather satellite orbits at a radius of 8.0 × 10⁶ m from Earth's centre. Given GM_Earth = 4.0 × 10¹⁴ m³ s⁻², calculate its orbital speed and period.", marks: 3, scheme: ["v = √(GM/r) = √(4.0 × 10¹⁴ / 8.0 × 10⁶) = 7071 m s⁻¹", "T = 2πr/v = 2π × 8.0 × 10⁶ / 7071 = 7107 s", "Period ≈ 1.97 h"], answer: "v = √(GM/r) = √(4.0×10¹⁴/8.0×10⁶) = 7071 m s⁻¹. The period is T = 2πr/v = 2π × 8.0×10⁶/7071 = 7107 s, about 1.97 h.", claim: "apply the circular-orbit relations numerically", aos: ["AO2"] },
