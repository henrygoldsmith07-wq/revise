// AQA A-level Chemistry — same authored questions retargeted to AQA spec points (closest to WJEC).
import { defineQuestions } from "./authoring";

const S = "aqa-alevel-chemistry";

export const chemistryAqaQuestions = defineQuestions([
  {
    slug: "chem-titration-moles-aqa",
    subjectId: S,
    topics: ["moles"],
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.moles.sp-01"],
  ...
  {
    slug: "chem-equilibrium-lechatelier-aqa",
    subjectId: S,
    topics: ["equilibria"],
    ...
    parts: [
      ...
      },
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.equilibria.sp-01"],
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.acids-bases.sp-01"],
  ...
  {
    slug: "chem-organic-mechanism-aqa",
    subjectId: S,
    topics: ["hydrocarbons"],
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.hydrocarbons.sp-01"],
  ...
  {
    slug: "chem-mcq-electron-config-aqa",
    subjectId: S,
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.atomic-structure.sp-04"],
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.energetics.sp-03"],
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.bonding.sp-04"],
  ...
  {
    slug: "chem-kinetics-maxwell-aqa",
    subjectId: S,
    topics: ["kinetics"],
    ...
    parts: [
      {
        ...
        specPointIds: ["aqa-alevel-chemistry.kinetics.sp-03"],
