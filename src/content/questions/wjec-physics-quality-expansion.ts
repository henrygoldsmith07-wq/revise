...
const questions: QuestionSpec[] = [
  ...
  },
  {
    ...
    parts: [
      ...
      qualityPart({ topic: "sports-physics", point: 2, demand: "calculation", family: "sports-physics:sprint", context: "sports-physics:sprint:hip-moment", prompt: "A 650 N ground reaction acts 0.040 m perpendicular to a knee joint. A muscle acts with a 0.025 m moment arm. Calculate the muscle force needed for static balance.", marks: 3, scheme: ["Take moments about the knee", "Ground-reaction moment = 650 × 0.040 = 26.0 N m", "F_muscle = 26.0/0.025 = 1040 N"], answer: "Take moments about the knee.\nmuscle moment = 650 × 0.040 = 26.0 N m\nmuscle force = 26.0/0.025 = 1.04 × 10³ N", move: "use perpendicular moment arms and a stated pivot", calculationRules: [{ kind: "method", label: "muscle moment", expected: 26, method: { operator: "*", operands: [650, 0.04] } }, { kind: "accuracy", label: "muscle force", expected: 1040 }, { kind: "unit", label: "muscle force", expected: 1040, unitAliases: ["N"] }] }),
