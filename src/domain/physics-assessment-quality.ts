...
function partLearningMetadata(question: Question, part: QuestionPart) {
  return part.learning ?? (question.learning ? {
    ...
    promptTarget: question.learning.promptTarget,
    expectedResult: question.learning.expectedResult,
    derivation: question.learning.derivation,
    evidenceSources: question.learning.evidenceSources,
