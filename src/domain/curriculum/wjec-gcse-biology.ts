...
export const aqaBiology: CurriculumModule = registerSubject({
  subject: {
    ...
    spec: { version: "2024-1.0", releaseDate: "2024-09-01", lastChecked: "2026-08-01", url: "https://www.wjec.co.uk/qualifications/biology-gcse/" },
  },
  units,
  topics,
});
