...
export const aqaBiology: CurriculumModule = registerSubject({
  subject: {
    ...
    spec: { version: "2024-1.0", releaseDate: "2024-09-01", lastChecked: "2026-08-01", url: "https://www.ocr.org.uk/qualifications/gcse/biology-a-gateway-j247-and-biology-b-twenty-first-century-j257-from-2016/" },
  },
  units,
  topics,
});
