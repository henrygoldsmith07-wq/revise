...
const SUBJECT_ID = "ocr-gcse-chemistry";
...
export const aqaChemistry: CurriculumModule = registerSubject({
  subject: {
    ...
    spec: { version: "2024-1.0", releaseDate: "2024-09-01", lastChecked: "2026-08-01", url: "https://www.ocr.org.uk/qualifications/gcse/chemistry-a-gateway-j248-and-chemistry-b-twenty-first-century-j258-from-2016/" },
  },
  units,
  topics,
});
