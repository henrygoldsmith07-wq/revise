...
/**
 * Completes onboarding (board → subjects → optional exam dates) for a fresh
 * profile. The funnel is the *only* thing rendered until it is done, so
 * every spec that needs a Today screen funnels through here.
